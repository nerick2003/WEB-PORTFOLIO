...
export interface Project {
  ...
  technologies: string[];
  featured?: boolean;
  status: 'completed' | 'in-progress' | 'maintained' | 'planned';
  year: string;
  category: string;
  screenshot?: string;
  liveDemo?: string;
...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      githubLink: "https://github.com/nerick2003",
      link: "",
      linkText: "View Live"
    },
    {
